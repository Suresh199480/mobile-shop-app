...
import { WatchesBrandsImgs } from '../../Data'
const WatchBrand = () => {
    return ( <
        >
        <
        div className = 'watch-brand-section' >
        <
        div className = 'container watch-brand-container' >
        <
        div className = 'row d-flex align-items-center justify-content-center' >
        <
        div className = 'col-md-6' >
        <
        div className = 'watch-brand-heading' > Pick Your Brand < /div> <
        div className = 'watch-brand-left' > {
            WatchesBrandsImgs.map((brand) => ( <
        ...
        div className = 'col-md-6' >
        <
        div className = 'watch-brand-right' >
        <
        div className = 'watch-brand-title' > Find and evaluate your phone to get the < br / > maximum cash! < /div> <
        div className = 'watch-brand-texts' >
        <
